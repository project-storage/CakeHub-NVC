...
let OrdersController = class OrdersController {
    ...
    async findAll(user, page, limit, status) {
        const result = await this.ordersService.findAll(user, +(page || 1), +(limit || 10), status);
...
__decorate([
    (0, roles_decorator_1.Roles)(client_1.Role.ADMIN, client_1.Role.ADVISOR, client_1.Role.USER),
    (0, common_1.Post)(),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, create_order_dto_1.UpdateOrderDto,
        types_1.UserPayload]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Cancel/Delete order' }),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __param(1, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, types_1.UserPayload]),
